...
const Split = () => {
    ...
    return (
        ...
        <Layout className="row" title='split heads' description='Ecommerce'>
            <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                {products &&
                    <div style={{ width: '40%', margin: '50px' }} className="col-6">
                        <h1 style={{ backgroundColor: '#001233', color: '#EFE0CA', padding: '20px', width: '100%' }}>Related Products</h1>
                        <br></br>
                        <Card style={{ marginLeft: '50px' }} product={products[4]}></Card>
                    </div>
                }
            </div>
        </Layout>
